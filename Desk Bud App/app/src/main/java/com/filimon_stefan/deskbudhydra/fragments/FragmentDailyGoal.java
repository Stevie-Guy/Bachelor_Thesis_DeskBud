...
public class FragmentDailyGoal extends Fragment {
    ...
    private void refreshUI(){
        ...
        if (procentGoal == 100){
            NotificationScheduler.anuleazaTimerInactivitate(requireContext());
        }
    ...
    private void adaugaApa(int ml){
        ...
        refreshUI();
        // Reseteaza contor de inactivitate
        NotificationScheduler.resetTimerInactivitate(requireContext());
    }
